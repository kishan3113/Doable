...
const WorkerDashboard = ({ workerName, workerId }) => {
  ...
  const [bookingsOpen, setBookingsOpen] = useState(false); // Dropdown state
  ...
  if (!workerData) return <div>Profile data not found.</div>;
